...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "68bbdc2150e7e0ffc593";
...
module.exports = function () {
    console.log('migration 1 was called');
};


/***/ }),

/***/ "./migrations/migration_2.ts":
/*!***********************************!*\
  !*** ./migrations/migration_2.ts ***!
  \***********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const serve_static_1 = __importDefault(__webpack_require__(/*! serve-static */ "serve-static"));
...
class Router {
    ...
    applyRouter(router) {
        lodash_1.default.defaultsDeep(this.routes, router.routes);
    }
}
...
const cookies_1 = __importDefault(__webpack_require__(/*! cookies */ "cookies"));
const multer = __webpack_require__(/*! fastify-multer */ "fastify-multer");
const url_1 = __importDefault(__webpack_require__(/*! url */ "url"));
const chain_middleware_1 = __webpack_require__(/*! ./chain-middleware */ "./server/chain-middleware.ts");
class Application {
    constructor(router) {
        ...
        for (let method in routes) {
            for (let path in routes[method]) {
                ...
                if (middleware.length > 1) {
                    this.app[method](path, chain_middleware_1.chainMiddleware(middleware));
                }
                else {
    ...
    preRequestHandler(req, res, next) {
        req.res = res;
        if (req.raw) {
            ...
            req._cookies = new cookies_1.default(req, res);
            req.req = req;
            if (!req.query) {
...
const factory_1 = __webpack_require__(/*! ./factory */ "./server/factory.ts");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function* () {
        let router = yield server_1.getRouter();
        const app = yield factory_1.getInstance(router);
...
/***/ 0:
/*!*****************************************************************************************************************************************!*\
  !*** multi webpack/hot/poll?1000 ./server/index.ts ./migrations/migration_1.ts ./migrations/migration_2.ts ./migrations/migration_3.ts ***!
  \*****************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! webpack/hot/poll?1000 */"./node_modules/webpack/hot/poll.js?1000");
__webpack_require__(/*! ./server/index.ts */"./server/index.ts");
__webpack_require__(/*! ./migrations/migration_1.ts */"./migrations/migration_1.ts");
__webpack_require__(/*! ./migrations/migration_2.ts */"./migrations/migration_2.ts");
module.exports = __webpack_require__(/*! ./migrations/migration_3.ts */"./migrations/migration_3.ts");
